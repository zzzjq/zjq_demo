...
//        // 清空数据
//        //	rt.jedis.zadd("zset", 10.3, "hello55");
//        //	System.out.println(shardedJedisPool.getResource().flushDB());
//        // 添加数据
//        shardedJedisPool.getResource().zadd("zset", 10.1, "hello");
//        shardedJedisPool.getResource().zadd("zset", 10.0, ":");
//        shardedJedisPool.getResource().zadd("zset", 10.2, "zset");
//        shardedJedisPool.getResource().zadd("zset", 11.0, "zset!");
//        // 元素个数
//        System.out.println(shardedJedisPool.getResource().zcard("zset"));
//        // 元素下标
//        System.out.println(shardedJedisPool.getResource().zscore("zset", "zset"));
//        // 集合子集
//        System.out.println(shardedJedisPool.getResource().zrevrange("zset", 0, 10));
//
//        System.out.println(shardedJedisPool.getResource().zrange("zset", 0, 10));
//        // 删除元素
//        System.out.println(shardedJedisPool.getResource().zrem("zset", "zset!"));
//        System.out.println(shardedJedisPool.getResource().zcount("zset", 9.5, 10.5));
//        // 整个集合值
//        //	System.out.println(shardedJedisPool.getResource().zrange("zset", 0, -1));
//
//    }
//
//    /**
