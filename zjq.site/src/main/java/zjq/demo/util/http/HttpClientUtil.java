...
//		String date = ZjqDate.getDateYMSHMS();
...
//		list.add(new BasicNameValuePair("timestamp", date));
...
//		String response = post("https://webgate.sumpay.cn:8088/webgate/payForDeclare.htm", list);
		String response = post("http://121.201.18.232/jxdata/api/auth/execute.do", list);
